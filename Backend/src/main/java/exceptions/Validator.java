...
public class Validator {
	 ...
	 *
	 * @param argument
	 *            the string on which to perform the {@code null} and empty
	 *            check
	 * @throws IllegalStateException
	 *             if {@code argument} is {@code null} or empty
	 ...
	 * @throws IllegalStateException
	 *             if the specified {@code object} is {@code null}.
